          ...
          <el-col v-if="form.menuType !== 'F'" :span="12">
            <el-form-item>
              ...
              <el-radio-group v-model="form.visible">
                <el-radio v-for="dict in status_display" :key="dict.value" :value="dict.value">{{ dict.label }} </el-radio>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item>
              ...
              <el-radio-group v-model="form.status">
                <el-radio v-for="dict in status_enabled" :key="dict.value" :value="dict.value">
                  {{ dict.label }}
                </el-radio>
              </el-radio-group>
            </el-form-item>
...
const { status_display, status_enabled } = toRefs<any>(proxy?.useDict('status_display', 'status_enabled'));
